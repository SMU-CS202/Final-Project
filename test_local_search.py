...
def test_local_search(small_sparse_graphs,
                      small_dense_graphs,
    ...
    for graph in range(len(small_dense_graphs)):
        ...
        print("Time Taken: ", test_case_runtime, "\n")
    print("Total Time: ", total_time)
    print("Average Time: ", total_time / len(small_dense_graphs))
    ...
    for graph in range(len(medium_sparse_graphs)):
        ...
        print("Time Taken: ", test_case_runtime, "\n")
    print("Total Time: ", total_time)
    print("Average Time: ", total_time / len(medium_sparse_graphs))
    ...
    for graph in range(len(medium_dense_graphs)):
        ...
        print("Time Taken: ", test_case_runtime, "\n")
    print("Total Time: ", total_time)
    print("Average Time: ", total_time / len(medium_dense_graphs))
    ...
    for graph in range(len(large_sparse_graphs)):
        ...
        print("Time Taken: ", test_case_runtime, "\n")
    print("Total Time: ", total_time)
    print("Average Time: ", total_time / len(large_sparse_graphs))
    ...
    for graph in range(len(large_dense_graphs)):
        ...
        print("Time Taken: ", test_case_runtime, "\n")
    print("Total Time: ", total_time)
    print("Average Time: ", total_time / len(large_dense_graphs))
